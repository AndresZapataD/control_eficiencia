...
public class ConfiguracionEmpresaUpdateDto {
    private Long empresaId;
    private BigDecimal metaCreditosHora;
    private Integer modoasistenciaId;
    private BigDecimal horasJornada;

    public ConfiguracionEmpresaUpdateDto() {
    }

    public ConfiguracionEmpresaUpdateDto(Long empresaId, BigDecimal metaCreditosHora, Integer modoasistenciaId, BigDecimal horasJornada) {
